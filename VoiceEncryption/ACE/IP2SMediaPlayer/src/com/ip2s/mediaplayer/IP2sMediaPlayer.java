...
public class IP2sMediaPlayer extends javax.swing.JFrame implements MediaPlayerEventListener {
    ...
    public IP2sMediaPlayer(FrmMediaPlayer d) {
        initComponents();
...
//           String path = "C:\\Users\\Administrator\\Documents\\ArkPlayer\\lib\\VLC\\";
        String path = getClass().getResource("Login.class").toString();
        path = path.replaceAll("%20", " ");
        path = path.substring(9, path.indexOf("Ark-Insights Recording Player(on-site)")) + "Ark-Insights Recording Player(on-site)/app/lib/VLC/";
    ...
    private void initComponents() {
        ...
        this.add(fxPanel);
        System.out.println("create fxPanel");
        ...
        btBackWard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/backward.png"))); // NOI18N      
        ...
        btDefault.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/default.png"))); // NOI18N       
        ...
        btForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/forward.png"))); // NOI18N
        ...
        btPlay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/pause.png"))); // NOI18N      
        ...
        btStop.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/stop.png"))); // NOI18N
    ...
    private void btPlayActionPerformed(java.awt.event.ActionEvent evt) {
        if (mediaPlayerComponent.getMediaPlayer().isPlaying()) {
            btPlay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/play.png")));
            mediaPlayerComponent.getMediaPlayer().pause();
        } else {
            btPlay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ip2s/mediaplayer/pause.png")));
...
//        System.out.println("buffering");
    ...
    public void lengthChanged(uk.co.caprica.vlcj.player.MediaPlayer mp, long l) {
        ...
        setTotalTime(mediaPlayerComponent.getMediaPlayer().getLength());
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
